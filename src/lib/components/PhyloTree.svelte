...
<<<<<<< HEAD:src/components/PhyloTree.svelte
=======
    console.log("UPDATE COLOR FUNCTION CALLED");
>>>>>>> b8572b4 (ADD/FIX: Correct file structure, streamlined production/development environments):src/lib/components/PhyloTree.svelte
